...
func (flag *OutputFlag) Register(ctx context.Context, f *flag.FlagSet) {
	flag.RegisterOnce(func() {
		...
		flag.formatIndent = os.Getenv("GOVMREST_INDENT") != "false"      // Default to indented output
		flag.formatError = os.Getenv("GOVMREST_FORMAT_ERROR") != "false" // Default to formatted errors
	})
}
